...
title=cgi&description=cgi+is로 출력이 된다.
  -->
<form action="process_create.py"><!-- process_create.py로 아래 정보를 전송한다는 뜻 -->
    <p><input type="text" name="title" placeholder="title"></p> <!-- 네임의 타이틀은 서버에 전송될때 글상자에 입력한 정보를 타이틀이라는 이름으로 전송하겠다  -->
    <p><textarea rows="4" name="description" placeholder="description"></textarea></p> <!--텍스트상자 에 입력한 정보는 description이라는 이름으로 전송된다 -->
